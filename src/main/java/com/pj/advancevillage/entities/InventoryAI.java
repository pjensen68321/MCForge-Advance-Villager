...
public class InventoryAI  implements IInventory {
    ...
    public EntityAdvanceVillager entityAdvanceVillager;
    ...
    public InventoryAI(EntityAdvanceVillager p_i1750_1_)
    {
        this.entityAdvanceVillager = p_i1750_1_;
    }
...
//    }
    ...
    public ItemStack getStackInSlot(int slotNumber)
    {
        ...
        if (slotNumber >= aitemstack.length)
        {
            slotNumber -= aitemstack.length;
            aitemstack = this.armorInventory;
        }

        return aitemstack[slotNumber];
    }
    ...
    public void damageArmor(float p_70449_1_)
    {
        ...
        for (int i = 0; i < this.armorInventory.length; ++i)
        {
            ...
            {
                this.armorInventory[i].damageItem((int)p_70449_1_, this.entityAdvanceVillager);
...
//    }
    ...
    {
        return this.entityAdvanceVillager.isDead ? false : p_70300_1_.getDistanceSqToEntity(this.entityAdvanceVillager) <= 64.0D;
    }
